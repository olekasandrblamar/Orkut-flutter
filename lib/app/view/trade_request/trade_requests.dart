...
class Trade_requests extends StatefulWidget {
  const Trade_requests({Key? key}) : super(key: key);

  @override
  State<Trade_requests> createState() => _Trade_requestsState();
}

class _Trade_requestsState extends State<Trade_requests> {
  ...
  Stream<List<ModelTrade>> fetchdata() async*{
    final response=await http.get(Uri.parse('https://orkt.one/api/trade-requests'),
        headers: {
              ...
              itemBuilder: (context, index) {
                return TweenAnimationBuilder(
                  ...
                  child: tradeCard(
                    tradelist[index],
                    onPress: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Trade_details("", "", "", tradelist[index].id, "", tradelist[index].amount, "","","","","","")));
                    },
                  ),
                );
              },
